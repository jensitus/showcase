...
export class GravatarService {
     ...
     * @param size Image size (default 200px)
     ...
     * This is specifically for Gravatar and not meant for security purposes
     */
    private md5(str: string): string {
        ...
        function wordToHex(lValue: number): string {
            ...
            for (let lCount = 0; lCount <= 3; lCount++) {
                ...
                wordToHexValue = wordToHexValue + (lByte < 16 ? '0' : '') + lByte.toString(16);
            }
